...
@interface RNCarPlay : RCTEventEmitter<RCTBridgeModule, CPInterfaceControllerDelegate, CPListTemplateDelegate,  CPTabBarTemplateDelegate, CPNowPlayingTemplateObserver> {
